...
### Cluster 1：5 个机械脚本（独立可并行）

#### A1. `check_layer_proportion.py`（优先：价值/成本最高）
...
#### A2. `check_yaml_factual_consistency.py`
...
#### A3. `check_test_coverage_intent.py`
...
#### A4. `check_verdict_consistency.py`
...
#### A5. `check_decision_authority.py`（主线写，最复杂）
...
#### B2. 流水线脚本：`pipeline_audit.sh` 或 `audit_pipeline.py`
