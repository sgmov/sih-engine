...
- 判据红证对表：本文判据条目见 规格修订记录、家位与模块形、接口对表、规则包迁移等节。按证伪覆盖度载体如实申报：历史判据清单未逐件附可构造红证即零信息部分，清账路径为后继修订批逐件补红证，承 sih-math/docs/docmath-carriers-derivation-2026-09-04.md。
