...
第四步融回门。三查：验收判据全过、接口契约未变、回迁债已评估。三查过后经可插拔机制落为组件模块实现，单独发布能力并行保留，或按知止退役。融回评估有两重门槛即体量与时间，主判据为贡献度，2026-08-22 用户裁定：体量与时间是贡献度的载体与观察窗，贡献度即工具在真实治理工作中的实际作用与产出，空转的调用量不计入，两重门槛齐备且贡献度成立才开融回评估，不因判据全绿而提前，达标由用户裁量。
