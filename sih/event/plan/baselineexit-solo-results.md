...
| 验证件 | 39f02d35 |
| 正身件 | b450f29c |
| pk-070 出泊材料 | a3e73722 |
| checkcite 件 | cfde58ec |
| 迁移 diff 自证件 | 0555181a |
| 投影件 baseline-exit.json | 1ac0a1ef |
| 内容清单件（md 五件 sha256） | 024a769d |

- 链笔：意图 intent_refined 16ae7d33、出泊 parking_exited 87e85363，俱 2026-09-08 当日链。
