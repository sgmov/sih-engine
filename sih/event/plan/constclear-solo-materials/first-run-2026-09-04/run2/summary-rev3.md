...
- 磁盘条目文件 172 件（实态目录枚举：calculus 114 件居 calculus/llm-friendly-build/entries；order 21 件居 order/entries；probability 17 件居 probability/entries；topology 8 件居 topology/entries；algebra 12 件居 algebra/entries）
