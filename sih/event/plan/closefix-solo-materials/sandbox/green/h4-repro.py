...
def scenario_a():
    ...
    return {
        ...
        "backup_rows": len((HERE / "h4-a-backups" / LEDGER_REL).read_text(encoding="utf-8").splitlines()) if (HERE / "h4-a-backups" / LEDGER_REL).is_file() else 0,
        ...
        "GREEN": (ondisk - after == 0 and committed >= ondisk and final >= ondisk),
    }
